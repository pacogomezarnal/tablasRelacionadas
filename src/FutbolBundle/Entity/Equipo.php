...
class Equipo
{
     ...
     * @return Equipo
     */
    public function addEntrenadores(\FutbolBundle\Entity\Entrenador $entrenadore)
    {
     ...
     * @param \FutbolBundle\Entity\Entrenador $entrenadore
     */
    public function removeEntrenadores(\FutbolBundle\Entity\Entrenador $entrenadore)
    {
